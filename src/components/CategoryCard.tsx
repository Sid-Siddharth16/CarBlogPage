...
export default function CategoryCard({ image, title, description }: CategoryCardProps) {
  return (
    <div className="flex flex-col items-center bg-[#F4F0F8] rounded-xl p-6 w-full max-w-xs sm:max-w-[255px] mx-auto shadow-sm transition-transform transition-shadow duration-300 ease-in-out hover:scale-105 hover:shadow-lg">
